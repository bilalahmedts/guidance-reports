...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('users')->group(function () {
        ...
        Route::get('/edit/{users}', [UserController::class, 'edit'])->name('users.edit');
        Route::put('/edit/{users}', [UserController::class, 'update'])->name('users.update');
    });
    ...
    Route::prefix('cmu')->group(function () {
        Route::get('/', [CMUController::class, 'index'])->name('cmu.index');
        Route::get('/create', [CMUController::class, 'create'])->name('cmu.create');
        Route::get('/get-user-detail/{id}', [CMUController::class, 'getUserDetail'])->name('cmu.get-user-detail');
        Route::post('/store', [CMUController::class, 'store'])->name('cmu.store');
    });
});
