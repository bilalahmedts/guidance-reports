                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control datetimepicker-input datepicker" data-toggle="datetimepicker"
                            data-target=".datepicker" name="call_date" placeholder="Enter Call Date"
                            value="{{ $audit->call_date }}" required>
                    </div>
                    @error('call_date')
                        <div class="validate-error">{{ $message }}</div>
                    @enderror
                                        ...
                                        <td width="10%" class="radios">
                                            ...
                                            <label class="radio-inline qrating">
                                                <input type="radio" class="radio" id="datapoint" value="6"
                                                    @if ($response->answer == 6) checked @endif name="answer-{{ $response->id }}">
                                                N/A
                                            </label>
                                        </td>
                                    </tr>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <input type="text" class="form-control" name="percentage" id="percentage"
                                placeholder="Enter Percentage" value="{{ $audit->percentage }}" required>
                        </div>
                        @error('percentage')
                            <div class="validate-error">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" class="form-control" name="recording_duration" placeholder="HH:MM:SS"
                                value="{{ $audit->recording_duration }}" required>
                        </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <select name="outcome" class="form-control select2">
                                    <option value="">Select Option</option>
                                    <option value="accepted" @if ($audit->outcome == 'accepted') selected @endif>Accepted</option>
                                    <option value="rejected" @if ($audit->outcome == 'rejected') selected @endif>Rejected</option>
                                </select>
                            </div>
                        </div>
                        @error('outcome')
